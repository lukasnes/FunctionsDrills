...
function faveColorFinder(color){
  if(color === 'red'){
    ...
    return 'You need to evaluate your choice in colors.'
  }
}
...
let movie = bestMovie("Interstellar")
console.log(movie)
////////////////// PROBLEM 15 ////////////////////
...
function theEliminator(constestants,loser){
  for(i = 0;i < constestants.length; i++){
...
let theSurvivors = theEliminator(contestants,loser)
console.log(theSurvivors)
////////////////// PROBLEM 17 ////////////////////
...
//CODE HERE
function frogMerchant(goldPieces){
  console.log("How much are you buying?")
  if(goldPieces > 3){
    console.log(`I will let you buy ${Math.round(goldPieces / 3)} chocofrogs`)
  } else {
    console.log("You do not have enough coin!")
  }
}

let totalFrogs = frogMerchant(10)
...
//CODE HERE
let totalFrogs2 = frogMerchant(22)
